                                    ...
                                    if batters_ids_get:
                                        ...
                                        for j in batters_ids_get:
                                            ...
                                            try:
                                                ...
                                                player_name =str(player_name_get).strip() if player_name_get else ""
                                                ...
                                                if batting_json_get:
                                                    ...
                                                    try:
                                                        # print('Insertion section.............')
                                                        # print('Insertion section.............:',str(player_name))
                                                        ...
                                                        print("error in insert Batters: ", E)
                                                        # return None
                                    ...
                                    if pitchers_ids_get:
                                        for m in pitchers_ids_get:
                                            try:
                                                ...
                                                p_player_name =unicodedata.normalize('NFKD', p_player_name).encode('ascii', 'ignore').decode('ascii')
